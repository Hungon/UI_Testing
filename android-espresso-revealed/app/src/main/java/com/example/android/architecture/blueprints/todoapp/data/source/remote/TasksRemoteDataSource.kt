...
private constructor() : TasksDataSource {
    ...
    override fun completeTask(task: Task) {
        val completedTask = Task(task.title, task.description, task.id, task.image, true)
    ...
    override fun activateTask(task: Task) {
        val activeTask = Task(task.title, task.description, task.id, task.image)
    ...
    companion object {
        ...
        private fun addTask(title: String, description: String, image: ByteArray?) {
